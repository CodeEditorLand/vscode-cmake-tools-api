...
var UIElement;
(function (UIElement) {
	UIElement[(UIElement["StatusBarLaunchButton"] = 0)] =
...
(function (ConfigurationType) {
	...
	ConfigurationType[(ConfigurationType["ConfigurePreset"] = 1)] =
		"ConfigurePreset";
	...
	return __awaiter(this, void 0, void 0, function* () {
		...
		if (desiredVersion !== api.version) {
			if (exactMatch) {
				...
				console.warn(
					`[vscode-cmake-tools-api] CMake Tools API version ${desiredVersion} is not available. Using ${api.version}.`,
				);
			}
		}
		return api;
